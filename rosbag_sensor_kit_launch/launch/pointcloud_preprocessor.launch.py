...
# Modified for rosbag_sensor_kit (3 lidars instead of 4)
...
def generate_launch_description():
    ...
    rosbag_sensor_kit_launch_share_dir = get_package_share_directory("rosbag_sensor_kit_launch")
    ...
    add_launch_arg(
        ...
        os.path.join(
            rosbag_sensor_kit_launch_share_dir,
            "config",
